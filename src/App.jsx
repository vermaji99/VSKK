...
import PremiumLuxuryBackground from './components/PremiumLuxuryBackground';
...
function MainLayout({ isHeroComplete, setIsHeroComplete }) {
  ...
  return (
    <div className="relative text-white overflow-x-hidden">
      {/* Permanent Luxury Background */}
      <PremiumLuxuryBackground />
...
function App() {
  ...
  // Initialize Lenis once at start
  useEffect(() => {
  ...
  // Disable Lenis when hero is not complete
  useEffect(() => {
    if (lenisRef.current) {
      if (!isHeroComplete) {
