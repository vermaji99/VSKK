...
const Overlay = () => {
  ...
  return (
    <div className="w-screen text-white font-sans selection:bg-accent-gold selection:text-black overflow-x-hidden bg-deep-black">
      ...
      {/* 🎬 HERO SECTION */}
      <section id="hero-overlay" className="h-[100vh] flex flex-col items-center justify-center p-6 md:p-10 relative overflow-hidden bg-deep-black">
        <motion.div 
        ...
        <motion.div 
          ...
          className="z-10 text-center max-w-6xl glass-card p-10 md:p-20 lg:p-40 relative metallic-reflection"
        >
          <ScrollReveal y={30}>
            <div className="flex items-center justify-center gap-4 md:gap-8 mb-8 md:mb-12">
              <div className="w-8 md:w-12 h-[1px] bg-accent-gold/30" />
              <p className="small-text !text-accent-gold tracking-[0.4em] md:tracking-[0.6em]">
                {BUSINESS_DETAILS.name}
              </p>
              <div className="w-8 md:w-12 h-[1px] bg-accent-gold/30" />
            </div>

            <LetterAnimation text="Sovereign Excellence" delay={0.2} />

            <p className="text-lg md:text-[28px] font-serif italic text-white/50 mt-8 md:mt-12 mb-10 md:mb-20 tracking-wider">
              Where timeless craftsmanship meets Mau's finest heritage.
            </p>

            <button onClick={scrollToCollections} className="btn-premium group">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-30">
          {[...Array(mobile ? 10 : 25)].map((_, i) => (
            <motion.div
              ...
              className="absolute w-1 h-1 bg-accent-gold rounded-full blur-[2px] shadow-[0_0_10px_#D4AF37]"
              style={{ 
                top: `${Math.random() * 100}%`, 
