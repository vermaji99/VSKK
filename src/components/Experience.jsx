...
const SectionDivider = () => (
  <div className="w-full h-[1px] bg-gradient-to-r from-transparent via-accent-gold/30 to-transparent my-20" />
);
...
const Overlay = () => {
  return (
    <div className="w-screen text-white font-sans selection:bg-accent-gold selection:text-black overflow-x-hidden relative">
      {/* 💎 Masterpiece Section */}
      <section id="featured" className="section-padding px-6 md:px-40 bg-[#020202]/85 backdrop-blur-md relative overflow-hidden z-10">
          ...
          <div className="w-full lg:w-1/2">
            <ScrollReveal>
              <div className="relative aspect-[4/5] overflow-hidden rounded-[8px] shadow-2xl group cursor-none glass-card-3d">
                ...
                >
                  <div className="text-6xl md:text-8xl gold-text luxury-shimmer">VSKK</div>
                </motion.div>
      ...
      {/* 📜 Quote Section */}
      <section className="py-32 md:py-48 px-6 md:px-10 bg-[#020202]/85 backdrop-blur-md flex items-center justify-center text-center relative overflow-hidden z-10">
        <ScrollReveal>
      ...
      {/* 🧊 Sovereign Standards */}
      <section id="collections" className="section-padding px-6 md:px-40 bg-[#020202]/85 backdrop-blur-md relative overflow-hidden z-10">
        <ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16">
            {[
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                className="glass-card-3d p-8 md:p-16 flex flex-col items-center text-center group"
              >
                <motion.div 
                  animate={{ y: [0, -10, 0] }}
      ...
      {/* Footer */}
      <footer className="py-20 md:py-40 px-6 md:px-40 bg-[#020202]/90 backdrop-blur-md border-t border-white/5 relative overflow-hidden z-10">
